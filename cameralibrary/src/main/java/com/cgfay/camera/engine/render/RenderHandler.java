...
class RenderHandler extends Handler {
    ...
    // 切换LUT 颜色查找滤镜
    public static final int MSG_CHANGE_DYNAMIC_LOOK_UP = 0x18;
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_CHANGE_DYNAMIC_RESOURCE:
                ...
                break;
            case MSG_CHANGE_DYNAMIC_LOOK_UP:
                if(msg.obj == null){
                    thread.changeLookupFilter((Bitmap) null);
                }else{
                    thread.changeLookupFilter((Bitmap) msg.obj);
                }
                break;
            default:
